<?php if (!defined('__TYPECHO_ROOT_DIR__')) exit; ?>
	...
	<script>var allowNavAero=<?php if($this->options->navAero==0):?>true<?php else:?>false<?php endif;?>;var siteurl = '<?php $this->options->SiteUrl() ;?>';var owoJson = '<?php Utils::indexTheme('assets/OwO.json'); ?>';
