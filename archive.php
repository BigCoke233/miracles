		...
		<?php while($this->next()): ?>
             <div class="post-item ">
			  ...
			  <div class="col-md-6 post-item-content">
				...
				<p class="post-meta"><i class="iconfont icon-block"></i> <?php $this->category(','); ?>&emsp;<i class="iconfont icon-comments"></i> <?php $this->commentsNum('还没有评论', '仅有一条评论', '%d'); ?>&emsp;<i class="iconfont icon-clock"></i> <?php $this->date(); ?></p>
