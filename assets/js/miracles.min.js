...
function navColor() {
    if ($("#banner-content").hasClass("banner-font-black")) {
        if(navBar){navBar.addClass("nav-font-white");}
        if(navBarMobile){navBarMobile.addClass("nav-font-white");}
    } else {
...
console.log("%c 🎉 Theme Miracles %c by Eltrac https://guhub.cn %c ", "color: #fff; margin: 1em 0; padding: 5px 0; background: #29c75f;", "margin: 1em 0; padding: 5px 0; background: #efefef;", "display: block;margin-left:-0.5em;");