...
if(! defined('DISPLAYALLOW_ALL_EXTERNAL_SITES_ERROR_MESSAGES') )	define ('DISPLAY_ERROR_MESSAGES', true);				// Display error messages. Set to false to turn off errors (good for production websites)
...
if(! isset($ALLOWED_SITES)){
	...
	$ALLOWED_SITES = $GLOBALS['miraclesTimThumbAllowList'];
}
// -------------------------------------------------------------
